...
* [Introduction](/maginium/the-basics/actions#introduction)

* [AsObject](/maginium/the-basics/actions#introduction-1)

* [As Controller](/maginium/the-basics/actions#introduction-2)
...
#### [#](https://www.laravelactions.com/2.x/as-object.html#make)`make`
...
#### [#](https://www.laravelactions.com/2.x/as-object.html#run)`run`
...
#### [#](https://www.laravelactions.com/2.x/as-object.html#runif)`runIf`
...
#### [#](https://www.laravelactions.com/2.x/as-object.html#rununless)`runUnless`
...
### [AsController](/maginium/the-basics/actions#introduction-2)

#### [#](https://www.laravelactions.com/2.x/as-controller.html#invoke)`__invoke`
...
### [#](https://www.laravelactions.com/2.x/as-controller.html#methods-used)Methods used

*Lists all methods recognized and used by the* `ControllerDecorator`

#### [#](https://www.laravelactions.com/2.x/as-controller.html#ascontroller)`asController`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#jsonresponse)`jsonResponse`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#htmlresponse)`htmlResponse`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getcontrollermiddleware)`getControllerMiddleware`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#prepareforvalidation)`prepareForValidation`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#authorize)`authorize`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#rules)`rules`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#withvalidator)`withValidator`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#aftervalidator)`afterValidator`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getvalidator)`getValidator`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getvalidationdata)`getValidationData`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getvalidationmessages)`getValidationMessages`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getvalidationattributes)`getValidationAttributes`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getvalidationredirect)`getValidationRedirect`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getvalidationerrorbag)`getValidationErrorBag`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getvalidationfailure)`getValidationFailure`
...
#### [#](https://www.laravelactions.com/2.x/as-controller.html#getauthorizationfailure)`getAuthorizationFailure`
...
[PreviousStrings](/maginium/the-basics/strings)[NextCache](/maginium/the-basics/cache)
