...
* [Introduction](/maginium/the-basics/cache#introduction)

* [Configuration](/maginium/the-basics/cache#configuration)

  * [Driver Prerequisites](/maginium/the-basics/cache#driver-prerequisites)

* [Cache Usage](/maginium/the-basics/cache#cache-usage)

  * [Obtaining a Cache Instance](/maginium/the-basics/cache#obtaining-a-cache-instance)

  * [Retrieving Items From the Cache](/maginium/the-basics/cache#retrieving-items-from-the-cache)

  * [Storing Items in the Cache](/maginium/the-basics/cache#storing-items-in-the-cache)

  * [Removing Items From the Cache](/maginium/the-basics/cache#removing-items-from-the-cache)

  * [The Cache Helper](/maginium/the-basics/cache#the-cache-helper)

* [Atomic Locks](/maginium/the-basics/cache#atomic-locks)

  * [Managing Locks](/maginium/the-basics/cache#managing-locks)

  * [Managing Locks Across Processes](/maginium/the-basics/cache#managing-locks-across-processes)

* [Adding Custom Cache Drivers](/maginium/the-basics/cache#adding-custom-cache-drivers)

  * [Writing the Driver](/maginium/the-basics/cache#writing-the-driver)

  * [Registering the Driver](/maginium/the-basics/cache#registering-the-driver)

* [Events](/maginium/the-basics/cache#events)
...
[**Memcached**](/maginium/the-basics/cache#memcached)
...
#### [Redis](/maginium/the-basics/cache#redis)

Before using a Redis cache with Maginium, you will need to either install the PhpRedis PHP extension via PECL or install the `predis/predis` package (\~2.0) via Composer. [Maginium Sail](https://github.com/maginium/docs/blob/main/docs/%7B%7Bversion%7D%7D/sail/README.md) already includes this extension. In addition, official Maginium deployment platforms such as [Maginium Forge](https://forge.maginium.com) and [Maginium Vapor](https://vapor.maginium.com) have the PhpRedis extension installed by default.

For more information on configuring Redis, consult its [Maginium documentation page](https://github.com/maginium/docs/blob/main/docs/%7B%7Bversion%7D%7D/redis/README.md#configuration).

#### [DynamoDB](/maginium/the-basics/cache#dynamodb)
...
#### [MongoDB](/maginium/the-basics/cache#mongodb)
...
#### [Accessing Multiple Cache Stores](/maginium/the-basics/cache#accessing-multiple-cache-stores)
...
#### [Determining Item Existence](/maginium/the-basics/cache#determining-item-existence)
...
#### [Incrementing / Decrementing Values](/maginium/the-basics/cache#incrementing-decrementing-values)
...
#### [Retrieve and Store](/maginium/the-basics/cache#retrieve-store)
...
#### [Stale While Revalidate](/maginium/the-basics/cache#swr)
...
#### [Retrieve and Delete](/maginium/the-basics/cache#retrieve-delete)
...
#### [Store if Not Present](/maginium/the-basics/cache#store-if-not-present)
...
#### [Storing Items Forever](/maginium/the-basics/cache#storing-items-forever)
...
When testing calls to the global `cache` function, you may use the `Cache::shouldReceive` method just as if you were [testing the facade](https://github.com/maginium/docs/blob/main/docs/%7B%7Bversion%7D%7D/mocking/README.md#mocking-facades).
...
To execute code on every cache operation, you may listen for various [events](https://github.com/maginium/docs/blob/main/docs/%7B%7Bversion%7D%7D/events/README.md) dispatched by the cache:
...
[PreviousActions](/maginium/the-basics/actions)[NextCollections](/maginium/the-basics/collections)
